...
Complete Georgian language pack for MikoPBX including UI translations and voice prompts.

## What's Included

- **Voice Prompts**: Georgian voice prompts for system menus, greetings, and notifications
- **UI Translations**: Complete Georgian translation of MikoPBX admin interface
