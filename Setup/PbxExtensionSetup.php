...
namespace Modules\ModuleGeorgianLanguagePack\Setup;
 ...
 * PbxExtensionSetup
 *
 * Setup class for Georgian Language Pack Module
 *
 * This Language Pack module provides automatic installation of:
 * - Georgian UI translations from Messages/ka/ directory
 * - Georgian voice prompts from Sounds/ka-ge/ directory
 *
 ...
 *
 * @package Modules\ModuleGeorgianLanguagePack\Setup
 */
class PbxExtensionSetup extends PbxExtensionSetupBase
{
     ...
     */
    protected string $moduleUniqueID = 'ModuleGeorgianLanguagePack';

    /**
     * Additional actions before module installation
     *
     * For Language Pack modules, we check for conflicts with other Georgian packs.
    ...
    public function onBeforeModuleEnable(): bool
    {
        ...
        if ($conflictModule !== null) {
            $this->messages[] = "Cannot install: Another Georgian Language Pack ($conflictModule) is already installed. Please uninstall it first.";
            return false;
        }
    ...
    public function onAfterModuleEnable(): bool
    {
        SystemMessages::sysLogMsg(
            __CLASS__,
            'Georgian Language Pack installed successfully',
            LOG_INFO
        );
    ...
    public function onBeforeModuleDisable(): bool
    {
        SystemMessages::sysLogMsg(
            __CLASS__,
            'Uninstalling Georgian Language Pack',
            LOG_INFO
        );
    ...
    public function onAfterModuleDisable(): bool
    {
        SystemMessages::sysLogMsg(
            __CLASS__,
            'Georgian Language Pack uninstalled successfully',
            LOG_INFO
        );
